...
export default function Home() {
  ...
  <div className="footer-column">
    ...
    <a href="https://www.instagram.com/ej.valejur/" target="_blank" rel="noopener noreferrer">
      <img src="/instagram-feed-sample.png" alt="Instagram Feed" className="w-full rounded-md mt-4" />
    </a>
  </div>
